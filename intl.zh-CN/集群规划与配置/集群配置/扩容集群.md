...
![扩容界面](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17854/155704093810431_zh-CN.png)
...
![扩容状态](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17854/155704093810432_zh-CN.jpg)
...
1.  使用如下命令 SSH 登录到 master 主机。请在[集群详情](intl.zh-CN/集群规划与配置/集群配置/集群列表与详情.md#section_oyb_nkk_bhb)页的主机信息栏中获取集群 master 机器的公网 IP。
...
3.  登录到扩容节点，扩容节点的内网IP请在[集群详情](intl.zh-CN/集群规划与配置/集群配置/集群列表与详情.md#section_oyb_nkk_bhb)页的主机信息栏中获取：
