...
-   \(Optional\) Create MaxCompute projects and tables. See [Create a MaxCompute project](../../../../../intl.en-US/Prepare/Create a project.md#) and [Quick Start for MaxCompute](../../../../../intl.en-US/Quick Start/Create and view a table.md#).
