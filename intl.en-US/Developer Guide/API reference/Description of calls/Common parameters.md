...
|Signature|String|Yes|The result string of the signature. For more information about how to calculate a signature, see [Sign signatures](reseller.en-US/Developer Guide/API reference/Description of calls/Sign signatures.md#).|
