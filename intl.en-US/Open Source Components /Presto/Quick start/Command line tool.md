...
The command line tool uses [SSH to log on to an EMR cluster](reseller.en-US/Quick Start/Connect to a cluster using SSH.md#) and executes the following command to enter the Presto console:
