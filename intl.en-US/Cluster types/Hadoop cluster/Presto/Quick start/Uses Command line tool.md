# Uses Command line tool

This section describes how to use the command line tool to operate the Presto console.

The command line tool uses [Connect to the master node of an EMR cluster in SSH mode](/intl.en-US/Cluster Management/Configure clusters/Connect to a cluster/Connect to the master node of an EMR cluster in SSH mode.md) and executes the following command to enter the Presto console:
