# Step 3: Create a cluster {#concept_nrp_154_y2b .concept}

This topic describes how to create and configure an E-MapReduce \(EMR\) cluster.

## Prerequisite {#section_pgx_g4v_vgb .section}

Ensure that RAM authorization has been completed. For more information, see [Role authorization](../../../../reseller.en-US/Cluster Planning and Configurations/Cluster planning/Role authorization.md#).

## Open the cluster creation page {#section_w2j_2z4_y2b .section}
