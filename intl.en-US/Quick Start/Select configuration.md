...
EMR underlying storage supports OSS \(standard OSS only\) and HDFS. OSS has a higher data availability than HDFS. The data availability of OSS is 99.99999999%, while HDFS is 99.99999%.
