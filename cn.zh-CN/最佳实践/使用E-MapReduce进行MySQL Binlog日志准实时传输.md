...
3.  为SLS服务添加对应的配置文件，并检查数据是否正常采集。
    ...
    3.  等待约2分钟，通过SLS控制台查看日志数据是否上传成功，具体如图所示。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17964/153915565311863_zh-CN.png)
...
4.  准备代码，将代码编译成jar包，然后上传到OSS。
    ...
    3.  上传jar包。
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17964/153915565311865_zh-CN.png)
...
5.  搭建EMR集群，创建任务并运行执行计划。
    ...
    4.  查询Master节点的IP，如图所示：
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17964/153915565311867_zh-CN.png)
        ...
        ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17964/153915565311868_zh-CN.png)
...
6.  错误排查。
    ...
    ![](http://static-aliyun-doc.oss-cn-hangzhou.aliyuncs.com/assets/img/17964/153915565411869_zh-CN.png)
